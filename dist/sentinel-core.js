    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        try {
            if (request.params.name === "validate_task_context") {
                ...
                const result = await validator.validateTaskConfidence(String(args.content), String(args.identifier), intelligenceResult);
            ...
            if (request.params.name === "update_memory") {
                ...
                const dataToWrite = isBase64 ? security.decodeBase64(data) : data; // Logic correction for update_memory name consistency
...
//# sourceMappingURL=sentinel-core.js.map